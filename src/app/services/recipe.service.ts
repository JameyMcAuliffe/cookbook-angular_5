...
import { Ingredient, Instruction } from '../recipes/ingredient.model';
...
export class RecipeService {
	...
	private recipes: Recipe[] = [
		new Recipe(
			...
			], [new Instruction('cook da feesh'), new Instruction('eat da feesh')]),
		new Recipe(
			'Recipe 2', 
			'forbidden donut', 
			...
			], [new Instruction('give 1 soul'), new Instruction('get 1 donut')])
	];
